...
<script>
  ...
  function drawChart() {
    ...
    var options = {
      ...
      titleTextStyle: {color: 'white', fontSize: 30, bold: true},
        /*hAxis: {
          title: 'Vreme',
      ...
      colors: ['red'],
      lineWidth: 5,
      legend: {textStyle: {color: '#ccc', fontSize: 20}},
      backgroundColor : {
        fill: '#222',
        stroke: '#111',
        strokeWidth: 5
    ...
    var chart = new google.visualization.LineChart(document.getElementById('grafik-mobilni'));
